...
for( var i in alphabet ) {
    ...
    alphabetSounds[ letter ] = new buzz.sound('sounds/kid/'+ letter ); /*letra dentro do objeto alphabetSounds, onde será instanciado um objeto que chama o som referente a eltra*/
}
...
$( function() {
        ...
        $models.find( 'li' ).droppable( {
            ...
            drop: function( e, ui ) {
                ...
                if ( modelLetter == droppedLetter ) {
                    ...
                    if ( score == modelLetters.length ) { // caso a variavel score seja igual ao tamanho da palavra, a função wingame é chamada
                        winGame();
                    }    
                } else { // caso nao, ou seja, voce nao completou a caixinha das letras, é emitido o som de erro e a letra volta para seu lugar original
    ...
    function winGame() { // função chamada quando voce acerta a palavra 
